...
def sanity_checks(args):
    ...
    if args.teacher_name is None:
        assert args.alpha_ce == 0.0 and args.alpha_mse == 0.0 and args.alpha_cos == 0.0 and args.alpha_clm == 1.0
...
def main():
    ...
    parser.add_argument(
        "--teacher_type", choices=["bert", "roberta", "gpt2"], default="gpt2", help="Teacher type (BERT, RoBERTa)."
    )
    parser.add_argument("--teacher_name", type=str, required=False, help="The teacher model.", default=None)
